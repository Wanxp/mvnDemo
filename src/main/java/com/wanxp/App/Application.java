...
public class Application
{
    ...
    public static String filePath = "C:\\Users\\hugh\\Downloads\\data";//文件路径
    ...
    private static String dbUrl = "jdbc:mysql://localhost:32773/DB_WBOSP?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";//数据库url
     ...
     */
    private static void importPropertioes(String propertiesFile) throws IOException {
